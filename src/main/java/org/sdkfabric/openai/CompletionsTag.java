...
public class CompletionsTag extends TagAbstract {
    public CompletionsTag(HttpClient httpClient, ObjectMapper objectMapper, Parser parser) {
     ...
     */
    public CompletionResponse create(CompletionRequest payload) throws ClientException {
        try {
            ...
            URIBuilder builder = new URIBuilder(this.parser.url("/v1/chat/completions", pathParams));
            ...
            return this.httpClient.execute(request, response -> {
                if (response.getCode() >= 200 && response.getCode() <= 299) {
                    var data = this.parser.parse(EntityUtils.toString(response.getEntity()), new TypeReference<CompletionResponse>(){});
     ...
     */
    public CompletionCollection getAll(String after, Integer limit, String model, String order) throws ClientException {
        try {
            Map<String, Object> pathParams = new HashMap<>();
            ...
            return this.httpClient.execute(request, response -> {
                if (response.getCode() >= 200 && response.getCode() <= 299) {
                    var data = this.parser.parse(EntityUtils.toString(response.getEntity()), new TypeReference<CompletionCollection>(){});
